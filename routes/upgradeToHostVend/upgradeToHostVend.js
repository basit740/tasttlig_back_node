...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const response =
        await upgrade_service.approveOrDeclineHostVendorApplication(
          req.params.userId,
          "APPROVED",
          "",
          Details
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      // get the client info
      const client = await user_profile_service.getUserById(req.params.userId);
      ...
      setTimeout(() => {
        upgrade_service.approveOrDeclineVendorApplicationOnFestival(
          req.params.festivalId,
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const response =
        await upgrade_service.approveOrDeclineVendorApplicationOnFestival(
          req.params.festivalId,
          req.params.ticketPrice,
          req.params.userId,
          "APPROVED",
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      // set a timer to accept applicant
      setTimeout(() => {
        upgrade_service.approveOrDeclineSponsorApplicationOnFestival(
          req.params.festivalId,
          req.params.ticketPrice,
          req.params.userId,
          "APPROVED",
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const response =
        await upgrade_service.approveOrDeclineSponsorApplicationOnFestival(
          req.params.festivalId,
          req.params.ticketPrice,
          req.params.userId,
          "APPROVED",
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      // set a timer to accept applicant
      setTimeout(() => {
        upgrade_service.approveOrDeclineRestaurantApplicationOnFestival(
          req.params.festivalId,
          req.params.ticketPrice,
          req.params.userId,
          "APPROVED",
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const response =
        await upgrade_service.approveOrDeclineRestaurantApplicationOnFestival(
          req.params.festivalId,
          req.params.userId,
          "APPROVED",
          "",
