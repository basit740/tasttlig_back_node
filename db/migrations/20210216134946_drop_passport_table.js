exports.up = function (knex) {
  return knex.schema.createTable("passport_details", (table) => {
    ...
    table
      .string("ticket_booking_id")
      .unsigned()
      .index()
      .references("ticket_booking_confirmation_id")
      .inTable("ticket_details");
    table
      .integer("passport__id")
      .unsigned()
      .index()
    ...
    table
      .integer("passport_festival_id")
      .unsigned()
      .index()
      .references("festival_id")
      .inTable("festivals");
    table
      .integer("host_festival_id")
      .unsigned()
      .index()
      .references("host_id")
      .inTable("hosts");
