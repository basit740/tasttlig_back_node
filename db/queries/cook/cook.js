...
module.exports = {
  ...
  createCook: async (cook, user_id) => {
    ...
    const food_business_name = cook.food_business_name;
    const food_business_number = cook.food_business_number;
    ...
    const food_business_logo = cook.food_business_logo;
    const food_business_photo = cook.food_business_photo;
    const food_business_story = cook.food_business_story;
