...
// Add entertainment helper function
const addEntertainment = async (
  ...
  try {
    ...
    await trx("entertainment_images").insert(images);
...
// Update entertainment helper function
...
// Get user entertainment details helper function
